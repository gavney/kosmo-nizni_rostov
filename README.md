...
**Презентация:** `outputs/polar-mesh-pitch/Polar-Mesh-zashchita-5min.pptx`

**Деплой:** https://polar-mesh.duckdns.org/

## Результат (фикстура «полная группировка»)

Доступность end-to-end до шлюза G_MUR (цель кейса ≥90%):

- **C65 — 96.7%** (видимость 97.8%, макс. перерыв 8 мин)
- **C70 — 98.8%** (видимость 99.9%, макс. перерыв 2 мин)
- **C72 — 98.9%** (видимость 100%, макс. перерыв 2 мин)
